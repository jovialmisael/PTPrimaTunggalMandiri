...
class PdfService {
  ...
  Future<void> createCutiPdf(
      ...
      String address,
      String phone,
      int annualLeaveBalance, // <--- 1. TAMBAH PARAMETER INI (Sisa Cuti Awal)
      ) async {
    ...
    // Hitung Tanggal Masuk Kerja (End Date + 1 Hari)
    DateTime returnDate = endDate.add(const Duration(days: 1));

    // Hitung Sisa Cuti Akhir
    int remainingLeave = annualLeaveBalance - totalDays;
                            ...
                            child: pw.Padding(
                                ...
                                child: pw.Column(
                                    ...
                                    children: [
                                      ...
                                      pw.Divider(),
                                      // 2. TAMPILKAN HASIL TANGGAL MASUK KERJA (End Date + 1)
                                      _buildTableItem("Tgl. Masuk Kerja", ": ${DateFormat('dd-MM-yyyy').format(returnDate)}"),
                                      pw.SizedBox(height: 10),

                                      // 3. TAMPILKAN PERHITUNGAN SISA CUTI
                                      _buildTableItem("Sisa Cuti tahun", ": $annualLeaveBalance hari"),
                                      _buildTableItem("Cuti yang diambil", ": $totalDays hari (-)"),
                                      pw.Divider(),
                                      _buildTableItem("Sisa Cuti", ": $remainingLeave hari"),
                                    ]
                                )
                            )
                        ),
                        // ... (BAGIAN KANAN/CUTI KHUSUS SAMA) ...
                            ...
                            child: pw.Padding(
                                ...
                                child: pw.Column(
                                    ...
                                    children: [
                                      ...
                                      _buildSmallText("3. pernikahan saudara sekandung karyawan : 1 hari"),
                                      _buildSmallText("4. Mengkhitankan / Membaptis Anak : 2 hari"),
                                      _buildSmallText("5. Istri melahirkan/keguguran : 2 hari"),
                                      _buildSmallText("6. Suami/ istri, orangtua/ mertua, atau anak meninggal: 2 hari"),
                                      _buildSmallText("7. Anggota keluarga serumah meninggal : 1 hari"),
                                      _buildSmallText("8. Tertimpa bencana alam kecuali banjir: 1 hari"),
